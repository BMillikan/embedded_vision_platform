#ifndef __DISPLAY_CUDA_CU__
#define __DISPLAY_CUDA_CU__
...
extern "C"
void allocTexture(int imageWidth, int imageHeight)
{
...
extern "C"
void copyTextureToGPU(int imageWidth, int imageHeight, uchar *h_data)
{
